...
public class TicketClassesPage {
	...
	static By ticketClassField = By.name("ddlClasses");
	...
	static String newString, initialString, ticketClassName;
	static int scenario;
	...
	public static void editAttendanceString() {
		...
		ticketClassName = Browser.instance.findElement(ticketClassField).getText();
	...
	public static void goTo() {
        ...
        Browser.instance.findElement(By.linkText("Ticket Classes")).click();
        WebDriverWait wait = new WebDriverWait(Browser.instance,10);
		wait.until(ExpectedConditions.elementToBeClickable(editButton));
	}
	...
	public static void editAndCancelClasses() {
		Browser.instance.findElement(editButton).click();
		WebDriverWait wait = new WebDriverWait(Browser.instance,10);
		wait.until(ExpectedConditions.elementToBeClickable(saveButton));
