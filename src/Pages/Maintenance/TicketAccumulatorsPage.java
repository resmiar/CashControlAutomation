...
public class TicketAccumulatorsPage {
	...
	static By accumulatorfield = By.name("txtAccumulator");
	static By accumulatorDropdown = By.id("dddAccumulator");
	...
	public static void addNew() {
		...
		Browser.instance.findElement(accumulatorfield).sendKeys(regionName);
	...
	public static void deleteLastAdded() {
		WebDriverWait wait = new WebDriverWait(Browser.instance,10);
		wait.until(ExpectedConditions.elementToBeClickable(addNew));
		Select regionValue = new Select(Browser.instance.findElement(accumulatorDropdown));
	...
	public static void editAccumulator() {
		Select regionValue = new Select(Browser.instance.findElement(accumulatorDropdown));
		regionValue.selectByVisibleText(regionName);
	...
	public static void goTo() {
        ...
        Browser.instance.findElement(By.linkText("Ticket Accumulators")).click();
        WebDriverWait wait = new WebDriverWait(Browser.instance,10);
		wait.until(ExpectedConditions.elementToBeClickable(addNew));
	}
	...
	public static void editAndCancelAccumulator() {
		Select regionValue = new Select(Browser.instance.findElement(accumulatorDropdown));
		regionValue.selectByVisibleText(regionName);
		Browser.instance.findElement(editButton).click();
		WebDriverWait wait = new WebDriverWait(Browser.instance,10);
		wait.until(ExpectedConditions.elementToBeClickable(cancelButton));
		Browser.instance.findElement(accumulatorfield).sendKeys(regionName+"test");
    ...
    case 1: 
    	{textMessage = "This ticket accumulator already exists.";
    	...
    	break;}
    case 2: 
    	{textMessage = "Please enter ticket accumulator description.";
    	String actualMessage = Browser.instance.findElement(errorMessageDiv).getText();
    	if (actualMessage.equals(textMessage)) {
    		System.out.println("Inside if block");
    		returnValue = true;}
	...
	public static void addAccumulatorAgain() {
		Browser.instance.findElement(addNew).click();
		Browser.instance.findElement(accumulatorfield).sendKeys(regionName);
		Browser.instance.findElement(saveButton).click();
		WebDriverWait wait = new WebDriverWait(Browser.instance,10);
